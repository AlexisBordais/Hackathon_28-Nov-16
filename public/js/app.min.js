...
*/
(function (app) {})(require('angular').module('app', [require('angular-ui-router'), 'app.config', 'naif.base64', 'app.services', 'app.home', 'app.blog']));
;'use strict';
...
(function (app) {
    ...
    app.component('blogItem', {
        ...
        controller: ['PostsService', '$stateParams', '$state', function (PostsService, $stateParams, $state) {
            ...
            this.save = function () {
                _this.post.image = 'data:image/png;base64,' + _this.file.base64;
                _this.post.imageprofil = 'data:image/png;base64,' + _this.file2.base64;
                _this.post.imageprofil2 = 'data:image/png;base64,' + _this.file3.base64;
...
(function (app) {
    ...
    app.component('blogList', {
        ...
        controller: ['PostsService', '$stateParams', '$state', function (PostsService, $stateParams, $state) {
            ...
            if ($stateParams.lieu) {
                PostsService.filter($stateParams.lieu).then(function (res) {
...
(function (app) {
    ...
    app.component('home', {
        ...
        controller: ['PostsService', '$state', function (PostsService, $state) {
            ...
            this.filter = function (lieu, langage) {
                //j'essaie de cree ma fonction filtre par lieu'
...
(function (app) {
    ...
    app.service('PostsService', function ($http) {
        ...
        }, _defineProperty(_ref, 'filter', function filter(lieu, langage) {
            return $http.get('/api/posts' + '?lieu=' + '?langage');
        }), _defineProperty(_ref, 'getById', function getById(id) {
            // HTTP Request method GET with param (post id) to our express API
            return $http.get('/api/posts/' + id);
        }), _defineProperty(_ref, 'save', function save(post) {
            if (post._id) {
        ...
        }), _defineProperty(_ref, 'delete', function _delete(post) {
